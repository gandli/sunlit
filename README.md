...
Vue 3 + Vite implementation of [jackyzha0/sunlit](https://github.com/jackyzha0/sunlit).

**Live demo**: <https://sunlit-vue.pages.dev> (Cloudflare Pages)
...
src/
  main.js
  App.vue           Root composition
  styles.css        Global CSS (fixes upstream U1-U4)
  components/
    DappledLight.vue    Top-level compositor
    Leaves.vue          SVG wind filter + foliage
    Blinds.vue          23 shutters + 2 bars
    ProgressiveBlur.vue 4 blur layers
    Article.vue         Semantic copy
  composables/
