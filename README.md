# sunlit — React 19 port

React 19 + Vite implementation of [jackyzha0/sunlit](https://github.com/jackyzha0/sunlit).

**Live demo**: <https://sunlit-react.pages.dev> (Cloudflare Pages)
...
- **React 19** with hooks + StrictMode
- **Vite 7** for dev server + production build
