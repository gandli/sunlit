...
| JavaScript | Required for time‑based animation | **Zero** – all effects in pure HTML+CSS |
...
- ✅ **Zero JavaScript** – all effects in pure HTML+CSS
...
- ✅ **Performance** – Firefox automatically displaces displacement map for better performance
