...
SolidJS + Vite implementation of [jackyzha0/sunlit](https://github.com/jackyzha0/sunlit).

**Live demo**: <https://sunlit-solid.pages.dev> (Cloudflare Pages)
...
- **SolidJS.5** with `<script setup>` Composition API
