# sunlit — Svelte 5 port

Svelte 5 (Runes) + Vite implementation of [jackyzha0/sunlit](https://github.com/jackyzha0/sunlit).

**Live demo**: <https://sunlit-svelte.pages.dev> (Cloudflare Pages)
...
src/
  main.js
  App.svelte           Root composition
  styles.css        Global CSS (fixes upstream U1-U4)
  components/
    DappledLight.svelte    Top-level compositor
    Leaves.svelte          SVG wind filter + foliage
    Blinds.svelte          23 shutters + 2 bars
    ProgressiveBlur.svelte 4 blur layers
    Article.svelte         Semantic copy
  lib/
